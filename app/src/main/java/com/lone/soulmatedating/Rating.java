...
public class Rating {
    ...
    public  void OnRateButtonClick() {
        ...
        //Try Google play
        intent.setData(Uri.parse("market://details?id=com.lone.soulmatedating"));
        if (!MyStartActivity(intent)) {
            //Market (Google play) app seems not installed, let's try to open a webbrowser
            intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.lone.soulmatedating"));
            if (!MyStartActivity(intent)) {
